  ...
  public void render() {
    ...
    for (int i=console.size(); i>0; i--) {
      ...
      if ( (((this.x+this.height)-(i*main.consoleTextSize+2))-25)+main.Coffy<500-main.consoleTextSize-5) {
        ...
        text(console.get(constrain(floor(map(i, 0, console.size(), console.size(), 0)), 0, console.size())).split("COLORHERE")[0], 20, (((this.x+this.height)-(i*main.consoleTextSize+2))-25)+main.Coffy);
      }
    }
    fill(51, 150);
    stroke(0);
